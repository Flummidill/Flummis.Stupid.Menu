    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Master Mods [16]
                ...
                new ButtonInfo { buttonText = "Always Guardian (with Master)", method =() => Overpowered.AlwaysGuardianMaster(), disableMethod =() => Movement.EnableRig(), toolTip = "Makes you always be the guardian."},
